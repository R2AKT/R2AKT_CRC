...
void loop() {
  ...
  CRC8 = crc8_calc_tbl (CRC8, Buff, sizeof (Buff)/sizeof (Buff[0]));
  ...
  CRC16 = crc16_calc_tbl (CRC16, Buff, sizeof (Buff)/sizeof (Buff[0]));
  ...
  CRC32 = crc32_calc_tbl (CRC32, Buff, sizeof (Buff)/sizeof (Buff[0]));
